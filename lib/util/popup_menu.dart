...
class PopupMenu extends ChangeNotifier {
...
class CustomPopupMenu extends StatefulWidget {
  CustomPopupMenu({
    ...
    this.controller,
    this.arrowColor = const Color(0xFFFFFF),
    this.showArrow = true,
...
class _CustomPopupMenuState extends State<CustomPopupMenu> {
  ...
  void initState() {
    ...
    if (_controller == null) _controller = PopupMenu();
...
class _MenuLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    double anchorCenterX = anchorOffset.dx + anchorSize.width ;
    ...
    switch (menuPosition) {
      case _MenuPosition.bottomCenter:
        ...
        contentOffset = Offset(
          anchorCenterX - contentSize.width,
